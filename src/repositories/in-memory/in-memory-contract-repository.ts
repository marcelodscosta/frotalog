...
export class InMemoryContractRepository implements IContractRepository {
  ...
  async create(data: Prisma.ContractUncheckedCreateInput): Promise<Contract> {
    const contract: Contract = {
      ...
      commission_percentage: data.commission_percentage ? new Prisma.Decimal(data.commission_percentage.toString()) : null,
      commission_start_date: data.commission_start_date ? new Date(data.commission_start_date) : null,
      commission_end_date: data.commission_end_date ? new Date(data.commission_end_date) : null,
      created_at: new Date(),
      updated_at: new Date(),
